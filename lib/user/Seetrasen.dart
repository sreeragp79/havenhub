...
class seetrasen extends StatefulWidget {
  const seetrasen({super.key});

  @override
  State<seetrasen> createState() => _seetrasenState();
}

class _seetrasenState extends State<seetrasen> {
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                                image: AssetImage("assets/image/seetrasenn.png"),
                                fit: BoxFit.fill)),
                      ),
                    ),
                    SizedBox(
                          ...
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text("Located in Idaho, 90 metres from \n"
                                    "Ostsee Beach, Hotel Seeterrassen \n"
                              ...
                              Positioned(
                                ...
                                child: Padding(
                                  padding:  EdgeInsets.only(left: width/22.83),
                                  child: Image.asset("assets/image/250 rate.png",scale: width/200.75,),
                                ),
                              ),
