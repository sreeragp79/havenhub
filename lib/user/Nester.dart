...
class nester extends StatefulWidget {
  const nester({super.key});

  @override
  State<nester> createState() => _nesterState();
}

class _nesterState extends State<nester> {
  @override
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                                image: AssetImage("assets/image/Nester.png"),
                                fit: BoxFit.fill)),
                      ),
                    ),
                    SizedBox(
                          ...
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text("Dünenblick is located in Michigan, \n"
                                    "100 metres from Strand Michigan, \n"
                                    "less than 1 km from HundeStrand,",
                                  style: TextStyle(
