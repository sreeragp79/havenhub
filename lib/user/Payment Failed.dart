...
class PaymentFailed extends StatefulWidget {
  ResortAddingDetails resort;
  PaymentFailed({super.key,required this.resort});
              ...
              children: [
                ...
                Positioned(left: 50,top: 250,
                  child: IconButton(
                    ...
                    onPressed: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context) => ConfirmPay(hotel: widget.resort,),));
                    },
                  ),
                ),
                InkWell(
