...
class meree extends StatefulWidget {
  const meree({super.key});

  @override
  State<meree> createState() => _mereeState();
}
class _mereeState extends State<meree> {
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                                image: AssetImage("assets/image/meree.png"),
                                fit: BoxFit.fill)),
                      ),
                    ),
                    SizedBox(
                          ...
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text("Meeresbrise is located in Kalifornien, \n"
                                    "300 metres from Strand Kalifornien, 1\n"
                                    "km from HundeStrand, ",
                                  style: TextStyle(
