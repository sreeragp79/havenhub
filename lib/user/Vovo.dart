...
class vovo extends StatefulWidget {
  const vovo({super.key});

  @override
  State<vovo> createState() => _vovoState();
}

class _vovoState extends State<vovo> {
  @override
            ...
            child: Stack(
              children: [
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                                image: AssetImage("assets/image/vovoo.png"),
                                fit: BoxFit.fill)),
                      ),
                    ),
                    SizedBox(
                          ...
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text("Ferienwohnung Sonnenschein in\n"
                                    "Schönberg is set in Missouri, 1.2 km\n"
                                    "from HundeStrand",
                                  style: TextStyle(
                              ...
                              Positioned(
                                ...
                                child: Padding(
                                  padding:  EdgeInsets.only(left: width/22.83),
                                  child: Image.asset("assets/image/190m rate.png",scale: width/200.75,),
                                ),
                              ),
                ...
                Positioned(
                  left: width/1.40,
                  top: height/3.07,
                  child: Image.asset("assets/image/List 5.png",scale: width/102.75,),
                ),
