...
class strandhus extends StatefulWidget {
  const strandhus({super.key});

  @override
  State<strandhus> createState() => _strandhusState();
}
class _strandhusState extends State<strandhus> {
            ...
            child: Stack(
              children: [
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                                image: AssetImage("assets/image/strandhus.png"),
                                fit: BoxFit.fill)),
                      ),
                    ),
                    SizedBox(
                          ...
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text("Strandhus Windjammer, a property\n"
                                    "with barbecue facilities, is located in \n"
                                    "Kalifornien, 300 metres ",
                                  style: TextStyle(
                              ...
                              Positioned(
                                ...
                                child: Padding(
                                  padding:  EdgeInsets.only(left: width/22.83),
                                  child: Image.asset("assets/image/180 r.png",scale: width/200.75,),
                                ),
                              ),
                ...
                Positioned(
                  left: width/1.40,
                  top: height/3.07,
                  child: Image.asset("assets/image/List 3.png",scale: width/102.75,),
                ),
