...
class conti extends StatefulWidget {
  const conti({super.key});

  @override
  State<conti> createState() => _contiState();
}

class _contiState extends State<conti> {
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                                image: AssetImage("assets/image/Conttti.png"),
                                fit: BoxFit.fill)),
                      ),
                    ),
                    SizedBox(
                          ...
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text("This fully renovated, modern hotel\n"
                                    "offers elegant accommodation in the\n"
                                    "heart of Kiel. It lies directly opposite.",
                                  style: TextStyle(
