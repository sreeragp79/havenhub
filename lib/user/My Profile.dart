                          ...
                          child: Stack(
                            children: [
                              CircleAvatar(
                                ...
                                :value1.userProfileUrl.isNotEmpty
                    ?NetworkImage(value1.userProfileUrl)
                                    : AssetImage('assets/image/user22.png') as ImageProvider,
                                radius: 60,
                              ),
                              Padding(
                        ...
                        Consumer<Loginprovider>(
                          builder: (context,value2,child) {
                            return Container(
                              ...
                              child: Center(
                                child: TextField(
                                  controller: value2.signupPasswordController,
                                  maxLength: 12,
                                  decoration: InputDecoration(
                                    filled: true, // Set filled to true
                                    fillColor: Colors.grey.withOpacity(
