...
class klaus extends StatefulWidget {
  const klaus({super.key});

  @override
  State<klaus> createState() => _klausState();
}

class _klausState extends State<klaus> {
            ...
            child: Stack(
              children: [
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                                image: AssetImage("assets/image/klaus.png"),
                                fit: BoxFit.fill)),
                      ),
                    ),
                    SizedBox(
                          ...
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text("Klausdorfer Hof is situated in the\n"
                                    "Klausdorf district of Schwentinenthal\n"
                                    "just a 15-minute drive from Kiel.",
                                  style: TextStyle(
                              ...
                              Positioned(
                                ...
                                child: Padding(
                                  padding:  EdgeInsets.only(left: width/22.83),
                                  child: Image.asset("assets/image/178 rate.png",scale: width/200.75,),
                                ),
                              ),
                ...
                Positioned(
                  left: width/1.40,
                  top: height/3.07,
                  child: Image.asset("assets/image/list 6.png",scale: width/102.75,),
                ),
