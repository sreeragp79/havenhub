...
class clubHouse extends StatefulWidget {
  const clubHouse({super.key});

  @override
  State<clubHouse> createState() => _clubHouseState();
}

class _clubHouseState extends State<clubHouse> {
  @override
            ...
            child: Stack(
              children: [
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                                image: AssetImage("assets/image/ClubHose.png"),
                                fit: BoxFit.fill)),
                      ),
                    ),
                    SizedBox(
                          ...
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text("Situated less than 1 km from\n"
                                    "HundeStrand, 1.7 km from Strandbad\n"
                                    "Brasilien-Schonberg and 17 km from  ",
                                  style: TextStyle(
                              ...
                              Positioned(
                                ...
                                child: Padding(
                                  padding:  EdgeInsets.only(left: width/22.83),
                                  child: Image.asset("assets/image/150 rate.png",scale: width/200.75,),
                                ),
                              ),
                ...
                Positioned(
                  left: width/1.40,
                  top: height/3.07,
                  child: Image.asset("assets/image/List 4.png",scale: width/102.75,),
                ),
