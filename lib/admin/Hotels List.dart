...
import '../user/Am Seagle.dart';
import '../user/California.dart';
import '../user/ClubHouse.dart';
import '../user/Conti.dart';
import '../user/Favorite.dart';
import '../user/Home.dart';
import '../user/Klaus.dart';
import '../user/Meree.dart';
import '../user/Nester.dart';
import '../user/Profile.dart';
import '../user/Ruser.dart';
import '../user/Seetrasen.dart';
import '../user/Stay Vista.dart';
import '../user/Strandhus.dart';
import '../user/Vovo.dart';


class HotelListModals extends StatefulWidget {
  const HotelListModals({super.key});

  @override
  State<HotelListModals> createState() => _allClassState();
}

class _allClassState extends State<HotelListModals> {
