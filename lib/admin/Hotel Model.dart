...
class AdminHotelModel extends StatefulWidget {
  ResortAddingDetails hotel;
  AdminHotelModel({super.key,required this.hotel});

  @override
  State<AdminHotelModel> createState() => _CaliforniaState();

}

class _CaliforniaState extends State<AdminHotelModel> {
                            ...
                            child: Column(crossAxisAlignment: CrossAxisAlignment
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      Text(guestval.totalAmount(widget.hotel.price),
                                        style: TextStyle(
                                            fontSize: 40,
                                            fontFamily: "jeju2"
                                        ),
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            SizedBox(height: 23,),
                            Image(image: AssetImage("assets/image/wifi.png",),
                            ...
                            Image(image: AssetImage("assets/image/music72.png",),
